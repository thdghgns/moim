		...
		<div class="page">
			<form class="form-horizontal">
				<div class="form-group">
					<label for="study-title" class="col-md-3 col-sm-12 control-label">스터디
						이름</label>
				...
				<div class="form-group">
					<label for="study-subject" class="col-md-3 col-sm-12 control-label">스터디
						주제</label>

					<div id="study-subject" class="col-md-2 col-sm-12">
						<select name="subject" id="subject"
							class="col-md-12 col-sm-12 form-control">
				...
				<div class="form-group">
					<label for="study-intro" class="col-md-3 col-sm-12 control-label">스터디
						소개</label>

					<div id="study-intro" class="col-md-6 col-sm-12">
						<textarea id="intro" name="intro" required="required"
				...
				<div class="form-group">
					...
					<div id="study-limit">
						<div class="col-md-2 col-sm-8">
							<input id="limit" name="limit" type=number class="form-control"
								min="1" max="30" required="required" placeholder="Limit">
						</div>
...
<script>
	...
	$("#study-create-submit").on('click', function() {
		...
		$.ajax({
			type : "POST",
			url : "/study/save-study",
			data : JSON.stringify(params),
			dataType : "html",
			contentType : "application/json; charset=UTF-8",
			success : function(args) {
				alert("스터디가 생성되었습니다.");
				window.location.href = "http://localhost:8080/study/main";
			},
			error : function(e) {
